...
//
//  Abstract:
//  A data model for maintaining the app state, including the underlying object capture state as well as any extra app state you maintain in addition, perhaps with invariants between them.
//  
