...
//
//  Abstract:
//  A class to support the creation, listing, and filename support of a capture folder in the Documents directory which will contain three subdirectories --- one for images, one for reconstruction checkpoint, and one for the created model.
//  
