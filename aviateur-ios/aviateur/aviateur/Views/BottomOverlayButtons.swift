...
private let logger = Logger(subsystem: Aviateur.subsystem, category: "BottomOverlayButtons")
...
private struct CaptureButton: View {
    ...
    struct LocalizedString {
        static let startCapture = NSLocalizedString(
            "Start Audit Capture (Object Capture)",
            bundle: Bundle.main,
            value: "Start Audit Capture",
            comment: "Title for the Start Audit Capture button on the object capture screen.")
